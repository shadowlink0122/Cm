...
v0.10.0は**配列・ポインタ・型システムの完全な再設計**を含む大規模なアップデートです。C/C++との互換性を強化し、型安全性を保ちながら実用的なシステムプログラミングを可能にします。
...
v0.10.0の新機能を使ったサンプルコードは`examples/`と`tests/test_programs/`にあります:
