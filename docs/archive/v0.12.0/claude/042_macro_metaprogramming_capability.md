...
作成日: 2026-01-11対象バージョン: v0.11.0ステータス: 技術解説

## 重要な訂正

**インライン関数では新しい構文や言語機能は作れません。** **それができるのはマクロです。**
...
**作成者:** Claude Code **ステータス:** 技術解説**関連文書:** 040_inline_expansion_design.md, 041_inline_vs_macro_comparison.md