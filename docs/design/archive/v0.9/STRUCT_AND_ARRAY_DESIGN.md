...
| ネストしたフィールド代入 (`o.inner.x = 10`) | ✅ | ✅ | ✅ | 2025-12-20 実装 |
| 明示的構造体リテラル (`Point{x: 10, y: 20}`) | ✅ | ✅ | ✅ | 名前付きのみ |
| 暗黙的構造体リテラル (`{x: 10, y: 20}`) | ✅ | ✅ | ✅ | 2025-12-21 実装、型推論 |
| ネストした暗黙的リテラル | ✅ | ✅ | ✅ | 2025-12-21 実装 |
| impl内の暗黙的this (`return x`) | ✅ | ✅ | ✅ | 2025-12-20 実装 |
| thisキーワード (`return this`) | ✅ | ✅ | ⚠️ | パース可、値セマンティクス |
| 複合メソッド呼び出し (`o.inner.func()`) | ✅ | ✅ | ✅ | 動作確認済み |
| 配列リテラル (`[1, 2, 3]`) | ✅ | ✅ | ✅ | 2025-12-21 実装 |
| 構造体内の配列フィールド | ✅ | ✅ | ✅ | 2025-12-21 実装 |
| 構造体の配列 | ✅ | ✅ | ✅ | 2025-12-21 実装 |
| 配列内暗黙的構造体リテラル | ✅ | ✅ | ✅ | 2025-12-21 実装 |
...
|------|---------|
| 2025-12-20 | 初版作成 |
| 2025-12-20 | Phase 1（ネストした代入）実装完了 |
| 2025-12-20 | Phase 5, 6（複合メソッド、メソッドチェーン）追加 |
| 2025-12-20 | Phase 2（構造体リテラル）実装完了 |
| 2025-12-20 | impl内暗黙的thisアクセス実装 |
| 2025-12-20 | thisキーワードパース実装 |
| 2025-12-20 | 複合メソッド呼び出し動作確認 |
| 2025-12-21 | 構造体リテラル名前付き初期化のみに変更 |
| 2025-12-21 | 配列リテラル `[]` 構文実装 |
| 2025-12-21 | 構造体の配列、構造体内配列の完全サポート |