...
```bash
git clone https://github.com/your-org/Cm
cd Cm
```
...
✅ コンパイラをビルドできた  
✅ テストが実行できた  
⏭️ 次は [Hello, World!](hello-world.md) で最初のプログラムを書きましょう

## 関連リンク

- [プロジェクト構造](../../PROJECT_STRUCTURE.md)
- [コンパイラの使い方](../compiler/usage.md)
- [トラブルシューティング](../compiler/troubleshooting.md)

---

**前の章:** [はじめに](introduction.md)  
**次の章:** [Hello, World!](hello-world.md)
