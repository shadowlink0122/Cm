...
void MirLowering::generate_builtin_css_method(const hir::HirStruct& st) {
...
// to_css() は css() のエイリアス
void MirLowering::generate_builtin_to_css_method(const hir::HirStruct& st) {
...
void MirLowering::generate_builtin_is_css_method(const hir::HirStruct& st) {
