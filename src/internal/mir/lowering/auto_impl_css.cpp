...
void MirLowering::generate_builtin_css_method_for_monomorphized(const MirStruct& st) {
    std::string func_name = ast::typekey::spec_fn_prefix(st.name) + "__css";
...
void MirLowering::generate_builtin_to_css_method_for_monomorphized(const MirStruct& st) {
    std::string func_name = ast::typekey::spec_fn_prefix(st.name) + "__to_css";
    std::string css_func_name = ast::typekey::spec_fn_prefix(st.name) + "__css";
...
void MirLowering::generate_builtin_is_css_method_for_monomorphized(const MirStruct& st) {
    std::string func_name = ast::typekey::spec_fn_prefix(st.name) + "__isCss";
