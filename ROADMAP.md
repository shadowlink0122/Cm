...
## Version 0.11.0 - 多次元配列/スライスの完全サポートとLLVM高階関数
...
## Version 0.12.0 - クロージャと動的メモリ確保

### 目標
クロージャ（変数キャプチャ）と動的メモリ確保を実装し、高度なコレクション操作を可能にする。
